...
const Header = () => {
  ...
  return (
    <div>
      <nav className="flex justify-between items-center bg-white text-[#184681] text-base font-semibold font-medium md:py-10 md:px-10 py-5 px-5">
        <div className="flex items-center">
          <a className="nav_logo" href="/">
            <svg
              viewBox="0 0 139 47"
              fill="#fb534a"
              className="md:ml-0 -ml-[40px] md:w-[139px] md:h-[38px] h-[20px] mr-3"
          ...
          <p className="text-gray-500 md:text-[18px] flex">
            You're applying for{" "}
            <button type="button" className="flex items-center ml-2 text-[#0c2440] font-bold" onClick={() => setShowModal(true)}>
              £{amount}
              <svg
                width="12"
                height="12"
        ...
        <div>
          <div className="static justify-center items-center flex fixed inset-0 z-50 outline-none focus:outline-none bg-[#00000099]">
            <div className="relative rounded-lg w-4/12 my-6 mx-auto bg-white p-10">
              ...
              <p className="text-[#0c2440] text-xl">
                Current loan amount is {amount}.
              </p>
              <input
                type="number"
                min={0}
